...
Quality simply sees how many parts were good compared to all of the parts produces. It should be noted the a cancelled plate will deflate this metric. This gets balanced out for the TEEP metric by the inflation this causes when we calculate the performance metric later on. 
...
```{r, echo=FALSE}
printer_1_teep <- availability * quality * performance
```
